...
async def air_temperature_get(
    ...
    pagination_token: Annotated[Optional[StrictStr], Field(description="Pagination token for retrieving subsequent data pages")] = Query(None, description="Pagination token for retrieving subsequent data pages", alias="paginationToken"),
...
async def weather_get(
    api: Annotated[Optional[StrictStr], Field(description="Set the value to `wbgt` to fetch WBGT records")] = Query(None, description="Set the value to &#x60;wbgt&#x60; to fetch WBGT records", alias="api"),
